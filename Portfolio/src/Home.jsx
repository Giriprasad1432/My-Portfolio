    ...
    <main ref={containerRef} className="relative w-full bg-black select-none ">
      ...
      {showProjects && (
        ...
        >
          ...
          <ChevronLeft onClick={handleLeft} className=' bottom-10 left-1/4 text-gray-500 size-[40px] z-30 absolute md:left-4 hover:bg-white text-black rounded-full md:w-10 md:h-10 p-2 cursor-pointer transition-all duration-300 pointer-events-auto'></ChevronLeft>
          <ChevronRight onClick={handleRight} className='bottom-10 right-1/4  text-gray-500 size-[40px] z-30 absolute md:right-4 hover:bg-white text-black rounded-full md:w-10 md:h-10 p-2 cursor-pointer transition-all duration-300 pointer-events-auto'></ChevronRight>
        </section>
      )}
